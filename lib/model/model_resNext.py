...
import math
import time
from ..util.utils import BasicBlock, Bottleneck, Bottleneck_ResNext
...
class ResNeXt(nn.Module):
    ...
    def __init__(self, block, layers, num_classes, groups, width_per_group, cfg, conv1_bias):
...
def resneXt101(num_classes, cfg, pretrained=False):
    ...
    groups = 32
    width_per_group = 8
    model = ResNeXt(Bottleneck_ResNext, [3, 4, 23, 3], num_classes, groups, width_per_group, cfg, conv1_bias=False)
    if pretrained:
