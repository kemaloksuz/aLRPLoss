...
class aLRPLossRetinaHead(AnchorHead):
    ...
    def __init__(self,
        ...
        super(aLRPLossRetinaHead, self).__init__(
            num_classes,
            in_channels,
...
#        self.period = 783*2
    ...
    def loss(self,
        ...
        if pos_idx.sum() > 0:
            # transformation for IoU loss computation
            ...
            # GIoU loss for each bounding box.
            # Normally range of GIoU Loss is [0,2], and each loss should be divided by 2.
            # Also, each loss should be divided by 1-tau following LRP.
            # tau=0.5, and hence 0.5*2 = 1. (TO DO: Parametric implementation)
            loss_bbox = self.loss_bbox(
                pos_pred,
                pos_target,
                pos_weights)

            # aLRP Classification Component
            ...
            losses_cls, rank, order = self.aLRP_Loss.apply(flat_preds, flat_labels, loss_bbox)
