...
data_partition = {'dataset':'coco', 'path':'data/coco', 'train_set':'train2017', 'test_set':'val2017'}
...
batch_size = 8
# Learning Rate 
# 0.008 for aLRP Loss. 0.001 is used for AP Loss for 16 batch size in the paper. So we set 0.002 for 32 batch size.
...
out_dir = os.path.join('./models', 'APLoss500_r50')
