...
optimization = dict(image_per_gpu= 8, # Number of images per GPU
	                ...
	                total_epoch_num = 160, # Number of epochs to train
	                lr_decay_epoch = [90,110,140], # Decrease the leraning rate by a factor of 0.1 at the following epochs
...
logger = dict(interval = 50, # Logging Frequency and folder
	          out_dir = os.path.join('./models', 'aLRPLoss500_r101'))