...
iou_type = 'GIoU'
# If you use aLRP Loss, then choose whether to use Self-Balance. 
# Unless you check for ablation, set it True. While using AP Loss, it should be False.
self_balance = "True" 
...
out_dir = os.path.join('./models', 'aLRPLoss500_r50_ATSS')
